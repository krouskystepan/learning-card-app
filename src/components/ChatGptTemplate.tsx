    ...
    <div className="space-y-3 rounded-xl border border-border bg-muted/40 p-4">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          1) Zkopíruj prompt → 2) vlož ho do ChatGPT a pod něj text (nebo
          přilož soubor) → 3) zkopíruj celý JSON sem dolů a ulož. ChatGPT
          nesmí vrátit jen prázdnou šablonu — musí naplnit kartičky ze zdroje.
        </p>
      </div>
